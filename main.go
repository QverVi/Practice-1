...
// func getSheetDimensions(sheet *xlsx.Sheet) (rows int, cols int) {
// return sheet.MaxRow, sheet.MaxCol
// }
// парсинг Excel файла
func parseExcel(filepath string) (map[string]int, error) {
	...
	//rowsCount, colsCount := getSheetDimensions(sheet)
